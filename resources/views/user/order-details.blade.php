            ...
            <div class="col-lg-10">
                ...
                <div class="wg-box mt-5">
                    ...
                    <div class="my-account__address-item col-md-6">
                        <div class="my-account__address-item__detail">
                            ...
                            <p><strong>Building No.:</strong> {{ $order->address }}</p>
                            <p><strong>Street Name:</strong> {{ $order->locality }}</p>
                ...
                <div class="wg-box mt-5 text-right">
                    <form action="{{ route('user.order.cancel') }}" method="POST">
                        ...
                        <button type="button" class="btn btn-danger btn-sm cancel-order">Cancel Order</button>
                    </form>
                </div>
                @endif
            </div>
